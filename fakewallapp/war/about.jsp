				...
				<div class="post_user">
					...
					<div class="post-user">
						<span class="name-user clickable" title="Click to add a Friend">Fake Wall</span> <br /> <span
							class="timestamp clickable" title="Click to edit Time"> around 21<sup>st</sup> October 2012 </span>
					</div>
				</div>
				<div class="post-content">
					<span class="clickable" title="Click to edit the Post">About Us<br />A small team of developers.</span>
				</div>
				...
				<div class="response" id="response">
					<div class="comment">
						...
						<div class="comment-content">
							<span class="name-user clickable" title="Click to add a Name">Mark Zuckerburg</span> <span class="comment-text clickable"
